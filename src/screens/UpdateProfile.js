          ...
          <div className="mx-auto px-4 md:px-10 lg:px-20 xl:px-48 mt-4 flex flex-col md:flex-row justify-between pb-6 h-[calc(100vh-115px)]">
            <div className="w-full h-full mb-6 flex flex-col border-r border-solid border-gray-200">
              ...
              <p className=" font-semibold text-gray-700 mb-1 ml-5">
                Name:{" "}
                <span className="capitalize font-medium font-mono ml-2">
                  {user?.name}
                </span>
                <button
                  onClick={() => setIsNameOpen(!isNameOpen)}
                  className="font-medium text-sm ml-4 mb-1 text-blue-600 hover:text-blue-800"
                >
                  Edit
                </button>{" "}
              </p>
              <Dialog open={isNameOpen}>
                ...
                <DialogContent className="my-8 sm:mx-8">
                  <input
                    ...
                    className="focus:outline-none border border-solid border-gray-600 p-4 rounded"
                    required
                  />
                </DialogContent>
                <DialogActions>
              ...
              <p className=" font-semibold text-gray-700 ml-5">
                Email:{" "}
                <span className=" font-medium font-mono ml-2">
                  {user?.email}
                </span>{" "}
                <button
                ...
                <Dialog open={isPasswordOpen}>
                  ...
                  <DialogContent className="my-8 mx-4 sm:mx-12 md:mx-20 flex flex-col gap-4">
                    <input
                      ...
                      className="focus:outline-none border border-solid border-gray-600 p-3 rounded"
                      required
                    />
                    <input
                      type="password"
                ...
                <Dialog open={isDeleteOpen}>
                  ...
                  <DialogContent className="m-8">
                    <DialogContentText className="text-gray-900">
                      This will delete your bookings deltails also.
                    </DialogContentText>
                  </DialogContent>
                  <DialogActions>
                    <button
