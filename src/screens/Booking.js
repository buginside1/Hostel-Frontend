...
const Booking = () => {
  ...
  const PricePerDays = room?.PricePerDay * dates?.length;
  const vat = room?.PricePerDay * dates?.length * (18 / 100);
  const totalPricePerDay = PricePerDays;
                ...
                <div className="flex flex-col items-center">
                  ...
                  <div className="px-1 sm:px-3">
                    ...
                    <div className="ml-8 flex mb-4">
                      ...
                      <span className="font-mono">{room?.PricePerDay} Rs</span>
                    </div>
                  </div>
                </div>
                <div className="flex flex-col items-center">
                  <div className="px-1 sm:px-3">
                    ...
                    {/* <div className="ml-8 flex mb-4">
                      ...
                      <button onClick={() => setIsDateOpen(!isDateOpen)}>
                        <textarea
                          ...
                          rows={dates.length + 1}
                          cols={10}
                          className="py-2 px-1 sm:px-2 rounded-md border border-solid border-gray-400 text-gray-700 font-mono cursor-pointer break-all resize-none hover:bg-blue-200 transition duration-200"
                        />
                      </button>
                      <Modal
                    ...
                    <div className="ml-8 flex mb-4">
                      ...
                      <span className="font-mono">{totalPricePerDay} Rs</span>
                    </div>
                  </div>
                  <div className="px-1 sm:px-3 py-20 flex justify-center sm:justify-end items-center ">
                    <button
                      onClick={onCheckout}
                      className="py-4 w-60 block text-center rounded bg-blue-400 hover:bg-blue-500 transition duration-200 text-zinc-50 "
