                    ...
                    {(rowsPerPage > 2
                      ...
                      <TableRow key={booking._id} style={{ height: 72.8 }}>
                        ...
                        <TableCell align="center">
                          {booking.status}
                          <Tooltip
                            title={booking.status === "Complete" ? "" : "Edit"}
                            placement="right"
                            className="!ml-2"
                          >
                            <IconButton
                              ...
                              disabled={
                                booking.status === "Complete" ? true : false
                              }
                ...
                <div className="p-5">
                  ...
                  <DialogActions className="mt-4">
                    ...
                    <button
                      ...
                      onClick={editHandler}
                      className=" border-red-400 text-blue-400 hover:text-blue-500 hover:border-red-500 hover:bg-blue-200 border-solid border py-2 rounded-lg w-24 text-center transition duration-200 box-border"
                    >
                      Update
                    </button>
                  </DialogActions>
